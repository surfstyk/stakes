...
export function applyBrand() {
  ...
  set('--go', c.go)
  set('--go-deep', c.goDeep)
  set('--go-tint', c.goTint)
  set('--proceed', c.proceed)
  set('--proceed-deep', c.proceedDeep)
  set('--proceed-tint', c.proceedTint)
  set('--grey', c.grey)
  set('--cream', c.cream)
  set('--gold', c.gold)
  set('--nimiq-blue', c.nimiqBlue)
  set('--nimiq-gold-a', c.nimiqGoldA)
  set('--nimiq-gold-b', c.nimiqGoldB)
