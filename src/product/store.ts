...
const TEST_WINDOW_MS = 10 * 60_000 // TEMP(filming): 10-min join window for the demo-video shoot
const TEST_DAY_MS = 1 * 60_000 // TEMP(filming): 1-min "day" for the demo-video shoot
